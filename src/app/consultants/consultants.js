      ...
      <div className="max-w-7xl mx-auto px-4">
        ...
        <div className="bg-white dark:bg-gray-800 p-6 rounded-lg shadow mb-8">
          <div className="grid md:grid-cols-4 gap-4">
            <div>
              <label className="block text-sm font-medium mb-2 text-gray-700 dark:text-gray-300">Compétences</label>
              <input
                type="text"
            ...
            <div>
              <label className="block text-sm font-medium mb-2 text-gray-700 dark:text-gray-300">Expérience min</label>
              <select
...
function CandidateCard({ candidate, enhanced }) {
  ...
  return (
    <div className="bg-white dark:bg-gray-800 p-6 rounded-lg shadow hover:shadow-md transition">
      ...
      <div className="mb-4">
        <h4 className="font-medium text-sm text-gray-700 dark:text-gray-300 mb-2">Compétences</h4>
      ...
      {enhanced && candidate.analysis && (
        <div className="mb-4 p-3 bg-purple-50 dark:bg-purple-900 rounded">
          <h4 className="font-medium text-sm text-purple-800 dark:text-purple-200 mb-1">Analyse IA</h4>
          <p className="text-xs text-purple-700 dark:text-purple-100">
      ...
      <button className="w-full bg-blue-600 dark:bg-blue-700 text-white py-2 rounded hover:bg-blue-700 dark:hover:bg-blue-800 transition">
        Voir le profil
      </button>
    </div>
  );
